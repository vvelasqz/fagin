...
<<>>=
args <- list(
    scaffile='~/src/git/fagin/input/stat/scaffold-lengths.tab',
    nstringfile='~/src/git/fagin/input/stat/nstrings.tab',
    kbcompfile='~/src/git/fagin/input/stat/kb-composition.tab',
    treefile='~/src/git/fagin/input/tree'
)
@
...
\begin{figure}
    \center
<<cache=TRUE, fig.width=7, fig.height=6>>=
