...
load(paste0(config$d_cache, '/Arabidopsis_thaliana.vs.Arabidopsis_lyrata-LoadTarget.Rdat'))
target <- out
@
...
load(paste0(config$d_cache, '/Arabidopsis_thaliana.vs.Brassica_rapa-LoadTarget.Rdat'))
target <- out
# skipped
